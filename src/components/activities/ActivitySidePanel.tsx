  ...
  return (
    <div className="space-y-4">
      ...
      <Card variant="default" padding="lg">
        ...
        <p className="text-xs text-gray-300 dark:text-slate-600 mt-4 border-t border-gray-100 dark:border-slate-800 pt-3">
  ...
  return (
    <div className="space-y-1">
      <div className="flex items-center justify-between text-sm">
        ...
        <span
          className={`text-xs font-semibold tabular-nums ${isFull ? 'text-emerald-600' : 'text-gray-600 dark:text-slate-300'}`}
        >
          {current}
          <span className="text-gray-300 dark:text-slate-600 font-normal"> / {max}</span>
