...
const SIZE_CLASSES: Record<Level, string> = {
  1: 'font-display text-3xl font-bold tracking-tight text-text-primary',
  2: 'font-display text-xl font-semibold tracking-tight text-text-primary',
  3: 'text-base font-semibold text-text-primary',
  4: 'text-xs font-semibold uppercase tracking-wider text-text-muted',
};
