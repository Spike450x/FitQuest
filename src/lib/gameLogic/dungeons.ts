...
export const DUNGEON_TIERS: Record<DungeonTierId, DungeonTierDef> = {
  ...
  'dark-sanctum': {
    ...
    recLevelMin: 7,
    recLevelMax: 10,
    monsterPool: ['skeleton-warrior', 'dark-wolf', 'dark-mage', 'iron-husk', 'gloom-knight'],
...
export const DUNGEON_BOSSES: Record<DungeonTierId, DungeonBossDef> = {
  ...
  'spider-lair': {
    ...
    bossLootTable: [
      ...
      { itemId: 'spell-phantom-assault', chance: 0.12 },
    ],
  ...
  'dark-sanctum': {
    ...
    bossLootTable: [
      ...
      { itemId: 'spell-void-collapse', chance: 0.12 },
    ],
  ...
  'dragons-keep': {
    ...
    bossLootTable: [
      ...
      { itemId: 'spell-worldbreaker', chance: 0.08 },
      { itemId: 'spell-stellar-collapse', chance: 0.08 },
      { itemId: 'spell-thousand-cuts', chance: 0.08 },
      { itemId: 'spell-titans-fury', chance: 0.12 },
    ],
