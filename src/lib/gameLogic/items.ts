...
export const ITEM_CATALOG: ItemDef[] = [
  ...
  },
  {
    ...
    description: "A blade from the edge of existence. Unstoppable in skilled hands. +14 Strength, +10 Stamina.",
  },
  ...
  },
  {
    ...
    description: "Woven from captured wraith-essence. Light as air, tough as iron. +10 Defense, +5 Stamina.",
  },
  ...
  // ── Armor — Legendary ─────────────────────────────────────────────────────
  {
    ...
    description: "Blessed by celestial beings. Absorbs strikes that should be fatal. +20 Defense, +6 Health.",
  },
  ...
  // ── Accessories — Epic ─────────────────────────────────────────────────────
  {
    ...
    description: "Commands the battlefield. Feared by enemies, respected by allies. +7 Strength, +5 Wisdom, +4 Defense.",
  },
  {
    id: "emblem-of-valor",
    ...
    description: "Awarded to the mightiest champions. Strength and resilience in equal measure. +8 Strength, +8 Defense.",
  },
  ...
  // ── Accessories — Legendary ────────────────────────────────────────────────
  {
    ...
    description: "A fragment of a dead star. Raw universal power in the palm of your hand. +8 Strength, +8 Wisdom, +6 Defense, +4 Stamina.",
  },
  ...
  // ── Spells — Warrior ──────────────────────────────────────────────────────
  {
    ...
    price: 100,
    statBonuses: {},
    description: "A fearsome war cry that amplifies your next strike. +18 bonus damage. (Warrior only)",
    spellMechanics: {
  ...
  },
  {
    ...
    price: 200,
    statBonuses: {},
    description: "Strike with savage fury — pain fuels your recovery. +20 damage, heal 15 HP. (Warrior only)",
    spellMechanics: {
  ...
  },
  {
    ...
    price: 220,
    statBonuses: {},
    description: "A wall of shields that stuns and protects. Stun + +8 Defense this round. (Warrior only)",
    spellMechanics: {
  ...
  },
  {
    ...
    lootOnly: true,
    statBonuses: {},
    description: "Unleash the force of a titan. +40 damage, bypasses monster defense. (Warrior only)",
    spellMechanics: {
  ...
  },
  {
    ...
    price: 120,
    statBonuses: {},
    description: "Overflow with mana — deal damage and refuel your body. +15 + WIS damage, restore 25 + WIS Stamina. (Wizard only)",
    spellMechanics: {
      requirement: { type: "pair", diceCount: 3 },
      effect: { damage: 15, damageScalesWithWisdom: true, restoreStamina: 25, staminaScalesWithWisdom: true },
      magicCost: 3,
      classRestriction: "wizard",
    },
  },
  ...
  },
  {
    ...
    price: 220,
    statBonuses: {},
    description: "A relentless stream of arcane energy that tears through defenses. +30 + WIS damage, bypasses defense. (Wizard only)",
    spellMechanics: {
      requirement: { type: "straight", diceCount: 3, length: 3 },
  ...
  },
  {
    ...
    lootOnly: true,
    statBonuses: {},
    description: "Collapse reality on your enemy. +40 + WIS damage, bypass defense, stun. (Wizard only)",
    spellMechanics: {
      requirement: { type: "three_of_a_kind", diceCount: 4 },
  ...
  // ── Spells — Rogue ────────────────────────────────────────────────────────
  {
    ...
    price: 100,
    statBonuses: {},
    description: "Blend into shadow and strike — you're harder to hit in return. +15 damage, +6 Defense this round. (Rogue only)",
    spellMechanics: {
      requirement: { type: "sum_gte", diceCount: 2, value: 8 },
  ...
  },
  {
    ...
    price: 190,
    statBonuses: {},
    description: "Vanish into smoke — enemy is stunned and you recover. Stun, heal 25 + WIS HP. (Rogue only)",
    spellMechanics: {
      requirement: { type: "pair", diceCount: 3 },
  ...
  },
  {
    ...
    price: 210,
    statBonuses: {},
    description: "Coat your blade in life-draining venom. +25 damage, 40% returned as HP. (Rogue only)",
    spellMechanics: {
      requirement: { type: "straight", diceCount: 3, length: 3 },
  ...
  },
  {
    ...
    lootOnly: true,
    statBonuses: {},
    description: "A ghost-strike from nowhere — impossible to defend against. +40 damage, bypass defense, 50% lifesteal. (Rogue only)",
    spellMechanics: {
      requirement: { type: "three_of_a_kind", diceCount: 4 },
