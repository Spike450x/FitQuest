...
// Stable rarity ordering so each type's grid reads common → legendary.
...
function ItemCard({
  ...
  // Spells render their effect-school silhouette (SPELL_SILHOUETTES), not a
  // per-id item silhouette — match how the spell cards portray them elsewhere.
  const art =
