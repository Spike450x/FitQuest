...
## Current Status (last updated 2026-05-26 — Content-scaling PR2: Monster roster + new mechanics)
...
**Active focus:** Continuing the content-scaling drop. PR3 (items + art) is next, then PR4 (spells), then PR5 (achievements + bestiary + collection surface that consumes the `monstersKilled` data already being written here).
