...
## Current Status (last updated 2026-05-26 — Content-scaling PR3: Items + art)
...
**Active focus:** Continuing the content-scaling drop. PR4 (spells — 14 new spells + `dotDamage` / `cleanseSelf` `SpellEffect` fields + 3 legendary class spells) is up next, then PR5 (achievements + bestiary surface + collection surface — both surfaces will consume the `monstersKilled` data PR2 is already writing and the inventory data PR3 is already growing).
