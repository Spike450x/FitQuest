...
**Active focus:** Collections page + mobile nav polish closes out the UX surface work. Next on the roadmap: Achievements dedicated page (`/character/achievements`) — a full catalog view with locked/unlocked states, progress hints, and gold reward display (profile badge gallery already renders all 30 IDs; this adds the richer per-achievement view).
