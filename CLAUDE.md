...
## Current Status (last updated 2026-05-26 — Content-scaling PR1: Spirit stat + Meditation activity)
...
**Active focus:** Continuing the content-scaling drop. PR2 (monster roster + new mechanics — 9 new arena monsters filling levels 11–14, `siphon`/`armor-pierce` passives, `summon-add` active) is next, followed by PR3 (items + art), PR4 (spells), PR5 (achievements + bestiary + collection).
