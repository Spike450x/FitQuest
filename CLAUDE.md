...
## Current Status (last updated 2026-05-30 — Collections page + mobile nav overhaul)
...
**Active focus:** Collections page + mobile nav polish closes out the UX surface work. The Achievements catalog view (locked/unlocked states, descriptions, gold reward display) was delivered as the default tab of `/collections` rather than a separate `/character/achievements` route — the collections hub is the more natural home. Next on the roadmap: **Reputation / Wanted Board** — foundation currency for all social/endgame features.
